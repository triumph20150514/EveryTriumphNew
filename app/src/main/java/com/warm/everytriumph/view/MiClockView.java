...
import com.warm.everytriumph.utils.DensityUtils;

import java.util.Calendar;

/**
 * 仿小米时钟
 * 作者：http://blog.csdn.net/qq_31715429/article/details/54668668
 */
public class MiClockView extends View {
    ...
    private void getCanvasTranslate(MotionEvent event) {
        ...
        mCanvasTranslateY = percentArr[1] * mMaxCanvasTranslate; //////  形成视差效果
    }
    ...
    private void startShakeAnim() {
        ...
        Log.e("EndData", "rotateX" + mCameraRotateX + " rotateY:" + mCameraRotateY + " TransX:" + mCanvasTranslateX + " TransY:" + mCanvasTranslateY);
